  ...
  return (
    <div className="space-y-8">
      ...
      <p className="text-gray-600 leading-relaxed text-lg">
        {product.description ||
          "Elevate your daily experience with this premium product. Designed for those who appreciate quality and attention to detail."}
      </p>
        ...
        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-2xl">
          <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-primary">
            <svg
              ...
              strokeLinejoin="round"
            >
              <path d="M5 18 3.5 16.5" />
              <path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2" />
              <path d="M15 18H9" />
              <path d="M19 18h2a1 1 0 0 0 1-1v-4.2a2 2 0 0 0-.6-1.4l-3-3A2 2 0 0 0 17 8h-2" />
